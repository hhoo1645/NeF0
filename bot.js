...
client.on("message", message => {
 ...
 if (message.content === "!help") {
  ...
  const embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .addField("『Bot 1 | SySteam』 『اسم البوت』", true)
...
القسم الثالث مصمم البوت | ! RG | .Ṅę𝓕ớ,#7300
...
!support| القسم الثاني  الدعم الفني و المساعدة
قسم الثالث مصمم البوت ! RG | .Ṅę𝓕ớ,#7300
...
if (message.content === '!support') {
      message.author.send('server support https://discord.gg/PFkXFb').catch(e => console.log(e.stack));
...
if (message.content === '!invite') {
      message.author.send(' رابط البوت |  https://discordapp.com/oauth2/authorize?client_id=485647861573222421&permissions=8&scope=bot ').catch(e => console.log(e.stack));
